...
var marketApp = angular.module('marketApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'marketAppUtils', 'pascalprecht.translate', 'truncate']);
